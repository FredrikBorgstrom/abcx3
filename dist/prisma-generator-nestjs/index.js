...
import { Prisma#{AdditionalImports} } from '#{PrismaClientImportPath}';
...
var ControllerGenerator = class {
  ...
  async generateContent() {
    ...
    content = content.replace(/#{PrismaClientImportPath}/g, this.settings.PrismaClientImportPath);
...
var ServiceGenerator = class {
  ...
  async generateContent() {
    let nameGen = NameGenerator.singleton;
    let code = this.settings.GenerateEmptyControllersAndServices ? ServiceEmptyStub : ServiceStub;
    ...
    code = code.replace(/#{PrismaClientImportPath}/g, this.settings.PrismaClientImportPath);
